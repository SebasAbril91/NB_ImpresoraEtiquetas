...
public class InterfazImpresion2 extends javax.swing.JFrame {
    ...
    private void JBtImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBtImprimirActionPerformed
        ...
        //ZPL CODDE
        // Ajuste de posicion de etiqueta.
        Point posInicialXY = new Point(100, 10);

        // Informacion de envio.
        int iE_alturaFuente = 35;
        int iE_interlineado = 32;
        Point iE_posXY = new Point(375 + posInicialXY.x, 20 + posInicialXY.y);
...
//        System.out.println(informacionEnvio);
        ...
        if (numLineasInfoEnvio > 8) {
            ...
            int ventana = JOptionPane.showOptionDialog(this,
                    "Es posible que el texto de información de envió sobrescriba parcialmente la etiqueta, Se imprimirá "
        ...
        // Numero de orden y fecha de envio.
        long nO_codigo = cB_codigo;
        int nO_alturaFuente = 35;
        int nO_interlineado = 40;
        Point nO_posXY = new Point(50 + posInicialXY.x, 20 + posInicialXY.y);
